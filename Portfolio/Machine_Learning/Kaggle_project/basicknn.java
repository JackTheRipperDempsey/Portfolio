/*
 This is the basic k-nearest neighbor algorithm.
 */
...
public class basicknn {
  ...
  // This section is for use if you have a validation set that you're using in addition to the
  // training data
